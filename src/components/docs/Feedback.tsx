...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-zinc-50/50 py-1 pr-3 pl-1.5 text-sm text-zinc-900 ring-1 ring-zinc-500/20 ring-inset dark:bg-zinc-500/5 dark:text-zinc-200 dark:ring-zinc-500/30">
        <CheckIcon className="h-5 w-5 flex-none fill-zinc-500 stroke-white dark:fill-zinc-200/20 dark:stroke-zinc-200" />
