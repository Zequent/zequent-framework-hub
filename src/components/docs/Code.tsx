  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-zinc-400/10 ring-1 ring-zinc-400/20 ring-inset'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-zinc-300 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
