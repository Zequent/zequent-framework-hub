...
<div className="not-prose">
  <Button href="/docs/conversations" variant="text" arrow="right">
...
- [Check out the Conversations endpoint](/docs/conversations)
- [Learn about the different error messages in Protocol](/docs/errors)
