export const metadata = {
  title: 'zqnt Framework Setup Guide',
}

# zqnt Framework Setup Guide

This guide helps you set up and use the zqnt framework with your applications.
...
- Docker or Podman
- GitHub account with access to zqnt platform

## Setup

### 1. Configure Maven

First, configure Maven to access GitHub Packages. Add the following to your `~/.m2/settings.xml` file. This allows Maven to download the necessary zqnt framework dependencies.
...
Next, set up a new Maven project or edit existing Maven projects to add the zqnt framework dependency..
...
The zqnt framework relies on several services. You can run them easily using Docker or Podman.
