export const metadata = {
  title: 'Edge SDK -- Quickstart Guide',
}

# Edge SDK -- Quickstart Guide

This guide walks you through creating a new edge adapter project from scratch using the zqnt Edge SDK. By the end, you will have a running Quarkus application that receives commands from the platform and can push telemetry data.
...
- GitHub account with access to the zqnt packages repository
