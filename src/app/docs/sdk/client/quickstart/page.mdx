export const metadata = {
  title: 'zqnt Client SDK - Quick Start Guide',
}

# zqnt Client SDK - Quick Start Guide

## For Customers: Using the SDK in Your Project

This guide shows you how to use the zqnt Client SDK in your Java/Quarkus application.

## Step 1: Add Dependency

Add the zqnt Client SDK to your `pom.xml`:
...
Here's a complete REST API using the zqnt SDK:
