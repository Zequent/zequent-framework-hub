export const metadata = {
  title: 'zqnt Client SDK - Configuration Guide',
}

# zqnt Client SDK - Configuration Guide

## Overview

The zqnt Client SDK supports flexible configuration via **application.properties** or **environment variables**, allowing you to switch between environments (dev, staging, production) **without any code changes**.
